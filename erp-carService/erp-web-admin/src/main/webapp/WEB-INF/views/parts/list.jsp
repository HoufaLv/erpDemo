            ...
            <div class="box no-border">
                <div class="box-body">
                    <form method="get" class="form-inline pull-left">
                        ...
                        <input type="text" name="inventory" placeholder="库存量" class="form-control" value="${param.inventory}">
                        ...
                        <tbody>
                            <c:forEach items="${pageInfo.list}" var="parts">
                                <tr>
                                    ...
                                    <td>${parts.address}</td>
                                    <td><a rel="${parts.id}" class="btn-xs btn-success updateBtn" href="/parts/update/${parts.id}">更新</a> <a rel="${parts.id}" class="btn-xs btn-danger" href="javascript:;">删除</a></td>
                                </tr>
                            </c:forEach>
                        </tbody>
                    </table>
