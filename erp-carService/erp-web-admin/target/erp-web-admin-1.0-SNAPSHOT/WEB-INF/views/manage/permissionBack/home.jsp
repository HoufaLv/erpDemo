        ...
        <section class="content">
            <div class="box">
                <div class="box-header">
                    ...
                    <div class="box-tools">
                        <a href="/manage/permission/new" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> 新增权限</a>
                    </div>
                </div>
                <div class="box-body">
                        ...
                        <c:forEach items="${permissionList}" var="permission">
                            <tr class="treegrid-${permission.id}
                                <c:if test="${permission.parentId != 0}">
                                    treegrid-parent-${permission.parentId}
                                </c:if>">
                                ...
                                <td>
                                    <a class="btn btn-success btn-xs" href="/manage/permission/edit/${permission.id}" title="编辑">编辑</a>
                                    <a class="btn btn-danger btn-xs delLink" rel="${permission.id}" href="javascript:;" title="删除">删除</a>
                                </td>
                            </tr>
                        </c:forEach>
